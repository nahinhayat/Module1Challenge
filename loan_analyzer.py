...
print("The total value of all loans is", total_of_all_loans)
...
def pv_function(future_value, remaining_months, annual_discount_rate):
    present_value = (future_value / (1 + annual_discount_rate/12) ** remaining_months)
    return present_value

new_loan_present_value = pv_function(1000, 12, .2)
...
print("The data for the inexpensive loans has been saved to inexpensive_loans.csv")
